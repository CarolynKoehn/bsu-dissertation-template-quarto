...
\section{Introduction \{ch-intro\}}\label{introduction-ch-intro}
...
Please consult the guide from Graduate College\textasciitilde{}(Graduate
College 2021) for resolving any style issues that are not addressed by
the style class files that are provided along with this document. The
files associated with this style can be found on the GitHub
website\textasciitilde{}(Jain 2025).
...
\section{The Greatness of Wabi-sabi
\{ch-wabisabiGreatness\}}\label{the-greatness-of-wabi-sabi-ch-wabisabigreatness}

\subsection{Previous work}\label{previous-work}

The greatness of Wabi-sabi The Great derives from her early work as
documented in her books\textasciitilde{}Great (1952).

\subsection{What are their names?}\label{what-are-their-names}

Please consult the articles by Admirer\textasciitilde{}(Admirer 1970)
and Admirer, Smith and Doe\textasciitilde{}(Admirer, Smith, and Doe
...
authors, ``et al'' can be used.

Check the References on page\textasciitilde{}\pageref{refs} for an
example of how to format the references.
...
\includegraphics{figs/figure.pdf}\{\#fig-fuzzyImage fig-pos=`ht'
width=4.0in keepaspectratio\}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0674}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.1910}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0787}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0787}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0787}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0787}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0899}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0899}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0899}}@{}}
\caption{Comparison of Slow MPI Version and the Fast MPI
Version}\label{tbl-CSPV}\tabularnewline
\toprule\noalign{}
\multicolumn{3}{@{}>{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.3258} + 4\tabcolsep}}{%
\begin{minipage}[b]{\linewidth}\raggedright
Parameters
\end{minipage}} &
\multicolumn{7}{>{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.5843} + 12\tabcolsep}@{}}{%
...
\multirow{2}{=}{128} & \multirow{2}{=}{100} & Slow MPI(secs) & 2.11 &
3.91 & 5.78 & 8.26 & 10.91 & 14.17 & 19.47 \\
...
\caption{\label{tbl-SPWC}The Speedup of the MPI WRS Code and the HPF WRS
Code}
...
Here is Appendix A. See Appendix\textasciitilde{}(\textbf{app-Setup?})
for the experimental setup.

\section{Experimental Setup}\label{app-Setup}

Here is Appendix\textasciitilde{}(\textbf{app-Setup?}).
