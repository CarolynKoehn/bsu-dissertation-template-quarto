...
\begin{Highlighting}[]
\NormalTok{format:}
\NormalTok{  bsu{-}dissertation{-}pdf: default}
\end{Highlighting}
\end{Shaded}
...
When you want to show an algorithm or equation, use the \LaTeX~math
environment denoted by \texttt{\$\$} (Equation~\ref{eq-example}).
...
\bibitem[\citeproctext]{ref-quartorepo}
